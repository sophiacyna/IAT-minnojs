	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Nam giới', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'Nam giới'}, //Name of the category presented in the task.
			...
			category2 :	{
				name : 'Nữ giới', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'Nữ giới'}, //Name of the category presented in the task.
					css : {color:'#336600','font-size':'1.8em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
